	...
	*/
	void PrintMatch(ACSM_PATTERN * pattern, ACSM_PATTERN * mlist, int nline, int index)
	{
		...
		for (; temp != NULL; temp = temp->next)
		{
			char temp1[256];
			char temp2[256];
			strcpy(temp1, (char*)(temp->patrn));
			strcpy(temp2, (char*)(mlist->patrn));
			if (!strcmp(temp1, temp2)) //strcmp succeed return 0,So here use "!" operation
			{
				temp->nmatch++;
			}
